...
<!-- Content Wrapper. Contains page content -->
      ...
      <div class="row">
        <div class="col-xs-12 " align="center">
          <div class="box box-info">
            ...
            <div class="box-body content-wrapper__inventary-actions-container">
              <!-- /input-group -->
            ...
            <!-- /.box-body -->
              ...
              <a href="?mod=productos_agotados"><button type="button" class="btn btn-danger">
                PRODUCTOS AGOTADOS
              </button></a>

              <a href="?mod=servicios"><button type="button" class="btn btn-success">
                SERVICIOS
              </button></a>            
            </div>
          </div>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $('#tablaDatatable').load('paginas/datatables/inventario.php');
    });
  </script>