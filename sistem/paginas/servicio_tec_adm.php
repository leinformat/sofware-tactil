            ...
            <div class="box-body">
              <div class="row">
                <form action="php/query.php" method="post">
                      ...
                      <select class="form-control"  name="id_usuario"  required>
                           <?php include 'php/query.php'; ?>
                            <option value="">Seleccione un Técnico</option>
                             <!-- Bucle para extraer los Datos de las tabla Cliente -->
                            <?php while ($row=mysqli_fetch_array($list_tecnicos)): ?>
                            <option  name="" value="<?php echo $row['id_usuario']; ?>"><?php echo $row['nombre_usu']; ?></option>
                            <?php endwhile; ?>
                        </select>
                    </div>
                    <div class="col-xs-3">
                    ...
                    <br><br><br><br>
                    <div class="col-xs-2">
                      <label>Monto abonado por el Cliente</label>
                    ...
                    <div class="form-group col-xs-4">
                      ...
                      <textarea class="form-control" rows="3" name="desc_st" placeholder="Ingrese Tipo de Equipo, Accesorios y demas Caracteristicas"></textarea>
                    </div>
                      <br><br><br>
                    <div class="col-xs-2">
