	...
	<div class="col-md-12">
	   	<div class="box box-info">
            <div class="box-header with-border">
              ...
              <a href="?mod=rep_prestamos"><button  type="button" class="close fa fa-fw fa-mail-reply"></button></a>
            </div>
        	<div class="box-body">
                  ...
                  <tr>
                    <th scope="row"><?php echo $n++;?></th>
				      ...
				      <td><?php echo number_format($f['monto'],2) . " $";?></td>
			      		<?php $suma += $f['monto']; ?>
                    <td>
                      <a href="#" id="del-<?php echo $f["id_prestamo"];?>" class="btn btn-sm icon fa fa-trash fa-lg"></a>
