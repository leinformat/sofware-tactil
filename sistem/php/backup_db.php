 ...
 * @author Ing. Leonardo Morales leinformat@gmail.com
 * @version 1.0
 */

/**
 * Definir parametros de la base de datos
 */ 
define("DB_USER", 'u589447048_pinky');
define("DB_PASSWORD", '6455645Leo.');
define("DB_NAME", 'u589447048_pinky');
define("DB_HOST", 'localhost');
//define("BACKUP_DIR", 'C:\respaldo_leinformat'); // Comment this line to use same script's directory ('.')
...
if (php_sapi_name() != "cli") {
    echo '<div style="display:none;" style="font-family: monospace;">';
}
...
// Obtén el nombre del archivo de respaldo generado por el script
$backupFileName = $backupDatabase->backupFile;

// Verifica si BACKUP_DIR está definido y usa esa ubicación, de lo contrario, usa el directorio actual
$backupDir = defined('BACKUP_DIR') ? BACKUP_DIR : './BACKUP_DIR';

// Ruta completa al archivo de respaldo
$backupFilePath = $backupDir . '/' . $backupFileName.'.gz';

// Comprobamos si el archivo existe
if (file_exists($backupFilePath)) {
    print "<script>window.location='../?mod=backup_db&exito&file=$backupFileName';</script>";
} else {
    // Si el archivo no existe, se muestra un mensaje de error
    print "<script>window.location='../?mod=backup_db&error';</script>";
}
if (php_sapi_name() != "cli") {
    echo '</div>';
}